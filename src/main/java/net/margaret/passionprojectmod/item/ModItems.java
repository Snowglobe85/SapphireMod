...
import net.margaret.passionprojectmod.item.custom.FuelItem;
import net.margaret.passionprojectmod.item.custom.MetalDetectorItem;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, PassionProjectMod.MOD_ID);
